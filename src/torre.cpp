...
void Torre::dibuja() const {
    glPushMatrix();
    //TEXTURIZADO DE LA TORRE
    if (color == white) texturizado(posicion.x - 0.37, 5.01, posicion.z - 0.49, 0.75, 0.99, "imagenes/torreblanca.png", color.a);
    else texturizado(posicion.x + 0.4, 5.01, posicion.z + 0.49, -0.8, -0.99, "imagenes/torrenegra.png", color.a);
